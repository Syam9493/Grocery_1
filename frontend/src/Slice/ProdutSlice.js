...
const initialState = localStorage.getItem("checkItems")
  ? JSON.parse(localStorage.getItem("checkItems"))
  : {
      checkItems: [],
    };
...
export const { setCheckItems, addCheckItem, removeCheckItem, clearCheckItems } =
