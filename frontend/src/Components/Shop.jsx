    ...
    <div key={product._id} className='w-64 h-5xl bg-white rounded-xl shadow-xl p-3'>
                    <div className='flex flex-row justify-between'>
                            ...
                            <div className='bg-gray-100 p-2 shadow-2xl rounded-full'>
                                <button className='size-6' onClick={addToCart}>❤️</button>  
                            </div>
                        </div>
                        ...
                        <div className='mt-5 flex flex-row justify-between'>
                            ...
                            <button className='bg-green-200 rounded-2xl font-semibold text-md/1 text-green-700 px-2 py-1' onClick={addToCart}>
